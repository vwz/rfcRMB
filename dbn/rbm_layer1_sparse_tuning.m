function [vishid, visbiases, hidbiases, batchposhidprobs, poshidstates] = rbm_layer1_sparse_tuning(batchdata, numhid, maxepoch, restart, weight_sparse, weight_pair)
...
weight_pair = 20;% control |1^T W|_F^2 = 0
